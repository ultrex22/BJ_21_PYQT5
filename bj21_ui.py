...
"color: rgb(54, 54, 54)")
        ...
        self.player_textbox.setGeometry(QtCore.QRect(180, 160, 181, 71))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.hit_me.setGeometry(QtCore.QRect(220, 300, 111, 34))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.hold.setGeometry(QtCore.QRect(220, 340, 111, 34))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.hold.setFont(font)
        self.hold.setObjectName("hold")
        self.bet_amount = QtWidgets.QLineEdit(self.centralwidget)
        self.bet_amount.setGeometry(QtCore.QRect(220, 240, 113, 32))
        self.bet_amount.setAlignment(QtCore.Qt.AlignCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bet_amount.setPlaceholderText(_translate("MainWindow", "Bet $"))
